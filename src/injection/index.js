...
var checkExist = setInterval(function () {
    ...
    if (document.querySelectorAll('[title=Menu]').length && typeof webpackChunkbuild == "object") {
        ...
        if (!window.Store || !window.Store.Msg) {
            (function () {
                ...
                else window.webpackChunkbuild.push([[parasite], {}, function (o, e, t) { let modules = []; for (let idx in o.m) { modules.push(o(idx)); } getStore(modules); }]);
            })();
        }
